                        ...
                        ap_dimchange_t * dimchange)
{
  ...
  mset_t *r = mset_alloc_internal (pr, a->datadim - dimchange->intdim,
...
mset_unfold (mset_internal_t * pr, bool destructive, mset_t * a, ap_dim_t dim)
{
  ...
  r->mscons =
    ap_abstract0_substitute_linexpr (pr->man_mscons, true, r->mscons, msn1,
                                     expr, NULL);
#ifndef NDEBUG
  fprintf (stdout,
...
/**
 * @brief Split array @p dim on two arrays.
 *
 */
mset_t *
...
/**
 * @brief Change node @p dim depending on @p n.
 *
