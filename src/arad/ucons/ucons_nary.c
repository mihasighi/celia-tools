...
//                              (!test_l_leq_2(pr->man_dcons, r->econs, r->datadim, r->segmentdim ,n)));
      ...
      bool pat_sat =
        !test_singleton (pr->man_dcons, r->econs, r->datadim, r->segmentdim,
                         n);
      //test_l_leq_2(pr->man_dcons, r->econs, r->datadim, r->segmentdim ,n);
      ...
      if (sa2)
        {
          if (ru)
            {
              ru->dcons =
                ap_abstract0_meet (pr->man_dcons, false, sa1->dcons,
                                   sa2->dcons);
            }
          else
            {
          ...
          if (pat_sat)
            {
              ...
              if (ru)
              ...
              else
                {
                  ...
                  e_seg = pr->PI[sa1->key.type].e_seg;
                  keylen =
                    (u_seg + e_seg) * sizeof (size_t) +
                    sizeof (pattern_key_t);

                  checked_malloc (rn, pattern_t, 1,
                                  sizeof (pattern_t) + (u_seg +
                                                        e_seg) *
                                  sizeof (size_t), return NULL;
                    );
                  memset (rn, 0,
                          sizeof (pattern_t) + (u_seg +
                                                e_seg) * sizeof (size_t));
          ...
          if (pr->PI[sr->key.type].nr_y == 1)
            {
              ...
              ap_abstract0_t *aux =
                ap_abstract0_add_dimensions (pr->man_dcons, true, auxn,
                                             &dimadd, false);
              ap_dimchange_clear (&dimadd);
              sr->dcons =
                ap_abstract0_meet (pr->man_dcons, true, aux, sr->dcons);
            }
          else
            {
...
ucons_join (ap_manager_t * man, bool destructive, ucons_t * a1, ucons_t * a2)
{
  ...
  if (ucons_is_bottom (man, a1) && ucons_is_bottom (man, a2))
    return (destructive) ? a1 : ucons_bottom (man, a1->datadim,
                                              a1->segmentdim);
  if (ucons_is_bottom (man, a1))
    return (destructive) ? a2 : ucons_copy (man, a2);
  if (ucons_is_bottom (man, a2))
  ...
  r->econs =
    ap_abstract0_join (pr->man_dcons, destructive, a1->econs, a2->econs);
  ...
  ap_abstract0_t *aux_join =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a2->econs, &dimadd,
                                 false);
  ap_abstract0_t *aux_join_a1 =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a1->econs, &dimadd,
                                 false);
  ...
  ap_abstract0_t *y2aux_join =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a2->econs, &dimadd,
                                 false);
  ap_abstract0_t *y2aux_join_a1 =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a1->econs, &dimadd,
                                 false);
  ...
  for (sa1 = a1->udcons; sa1 != NULL; sa1 = sa1->hh.next)
    {
      ...
      ap_dim_t n = sa1->key.segments[0];
      bool pats1_sat_a2 =
        !test_singleton (pr->man_dcons, a2->econs, a2->datadim,
                         a2->segmentdim, n);
      ...
      if (sa2)
        {
          if (ru)
            {
              ru->dcons =
                ap_abstract0_join (pr->man_dcons, destructive, sa1->dcons,
                                   sa2->dcons);
            }
          else
            {
              ...
              if (nr_y == 2)
                {
                  ...
                  ord1 =
                    ap_abstract0_sat_lincons (pr->man_dcons, sa1->dcons,
                                              &arr.p[0]);
                  ord2 =
                    ap_abstract0_sat_lincons (pr->man_dcons, sa2->dcons,
                                              &arr.p[0]);

                  if (ord1 && ord2)
                    rn->dcons =
                      ap_abstract0_meet_lincons_array (pr->man_dcons, true,
                                                       rn->dcons, &arr);
              ...
              for (size_t ctr = 1; ctr < a1->segmentdim; ctr++)
                {
                  ...
                  //d(ctr) - d(y1) >= 0
                  ap_linexpr0_set_coeff_scalar_int (arr.p[0].linexpr0, dy1,
                                                    -1);
                  ap_linexpr0_set_coeff_scalar_int (arr.p[0].linexpr0, dctr,
                                                    1);
                  ap_linexpr0_set_cst_scalar_int (arr.p[0].linexpr0, 0);
                  ...
                  if (nr_y == 2)
                    {
                      ...
                      if (ord1 && ord2)
                        rn->dcons =
                          ap_abstract0_meet_lincons_array (pr->man_dcons,
                                                           true, rn->dcons,
                                                           &arr);
              ...
              if (ru)
                {
                  if (nr_y == 1)
                    ru->dcons =
                      ap_abstract0_join (pr->man_dcons, false, aux_join,
                                         sa1->dcons);
                  else
                    ru->dcons =
                      ap_abstract0_join (pr->man_dcons, false, y2aux_join,
                                         sa1->dcons);
                }
              else
                {
  ...
  for (sa2 = a2->udcons; sa2 != NULL; sa2 = sa2->hh.next)
    {
      ...
      ap_dim_t n = sa2->key.segments[0];
      bool pats2_sat_a1 =
        !test_singleton (pr->man_dcons, a1->econs, a1->datadim,
                         a1->segmentdim, n);
              ...
              if (ru)
                {
                  if (nr_y == 1)
                    ru->dcons =
                      ap_abstract0_join (pr->man_dcons, false, aux_join_a1,
                                         sa2->dcons);
                  else
                    ru->dcons =
                      ap_abstract0_join (pr->man_dcons, false, y2aux_join_a1,
                                         sa2->dcons);
                }
              else
                {
  ...
  if (aux_join)
    ap_abstract0_free (pr->man_dcons, aux_join);
  if (aux_join_a1)
    ap_abstract0_free (pr->man_dcons, aux_join_a1);
...
ucons_widening (ap_manager_t * man, ucons_t * a1, ucons_t * a2)
{
        ...
        if (ll != yy)
          {
            ...
            ord1 =
              ap_abstract0_sat_lincons (pr->man_dcons, a1->econs, &arre.p[0]);
            ord2 =
              ap_abstract0_sat_lincons (pr->man_dcons, a2->econs, &arre.p[0]);

            if (ord1 && ord2)
              {
                if (!ap_abstract0_sat_lincons
                    (pr->man_dcons, r->econs, &arre.p[0]))
                  {
#ifndef NDEBUG2
  ...
  ap_abstract0_t *aux_wide_a2 =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a2->econs, &dimadd,
                                 false);
  ap_abstract0_t *aux_wide_a1 =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a1->econs, &dimadd,
                                 false);
  ...
  ap_abstract0_t *y2aux_wide_a2 =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a2->econs, &dimadd,
                                 false);
  ap_abstract0_t *y2aux_wide_a1 =
    ap_abstract0_add_dimensions (pr->man_dcons, false, a1->econs, &dimadd,
                                 false);
      ...
      if (sa2)
        {
          if (ru)
            {
              ru->dcons =
                ap_abstract0_widening (pr->man_dcons, sa1->dcons, sa2->dcons);
#ifndef NDEBUG1
              fprintf (stdout, "\n \t wide neintarit  \n ");
              fprintf (stdout, "\n");
              fflush (stdout);
...
//                              rn->dcons = ap_abstract0_meet(pr->man_dcons,true,rn->dcons,pt1);
              ...
              if (ru)
                {
                  if (nr_y == 1)
                    ru->dcons =
                      ap_abstract0_widening (pr->man_dcons, aux_wide_a2,
                                             sa1->dcons);
                  else
                    ru->dcons =
                      ap_abstract0_widening (pr->man_dcons, y2aux_wide_a2,
                                             sa1->dcons);
                }
              else
                {
              ...
              if (ru)
                {
                  if (nr_y == 1)
                    ru->dcons =
                      ap_abstract0_widening (pr->man_dcons, aux_wide_a1,
                                             sa2->dcons);
                  else
                    ru->dcons =
                      ap_abstract0_widening (pr->man_dcons, y2aux_wide_a1,
                                             sa2->dcons);
                }
              else
                {
  ...
  if (aux_wide_a1)
    ap_abstract0_free (pr->man_dcons, aux_wide_a1);
  if (aux_wide_a2)
    ap_abstract0_free (pr->man_dcons, aux_wide_a2);
