...
#define hgraph_init_from_manager(man,id,size)  \
	((hgraph_internal_t*) sh_init_from_manager(man,id,size))
...
bool hgraph_node_are_iso (hgraph_internal_t * pr, hgraph_t * a, node_t n1,
                          node_t n2);
...
void hgraph_node_anon_array_clear (ap_dim_array2_t * anon);
...
hgraph_t *hgraph_assign_x_y_next (hgraph_internal_t * pr, bool conservative,
                                  ...
                                  ap_dimperm_t * perm);
hgraph_t *hgraph_substitute_x_y_next (hgraph_internal_t * pr,
                                      bool conservative, hgraph_t * a,
                                      size_t vx, size_t vy,
                                      ap_dimperm_t * perm,
                                      ap_dim_array2_t * anon);
...
hgraph_t *hgraph_dup_dimensions (hgraph_internal_t * pr, hgraph_t * a,
                                 ...
                                 ap_dimperm_t * perm, ap_dimperm_t * eqrel);
  /* duplicate all not null nodes and label them in dimchange */
hgraph_t *hgraph_remove_dimensions_internal (hgraph_internal_t * pr,
                                             bool destructive, hgraph_t * a,
                                             ap_dimchange_t * dimchange,
                                             ap_dimperm_t * perm);
  /* remove real dimensions from dimchange and reorder nodes */
hgraph_t *hgraph_permute_dimensions_internal (hgraph_internal_t * pr,
                                              bool destructive, hgraph_t * a,
                                              ap_dimperm_t * inperm,
