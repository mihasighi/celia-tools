...
void camlidl_ml2c_hgraph_internal_ptr(value _v1, internal_ptr * _c2, camlidl_ctx _ctx)
{
  *_c2 = *((internal_ptr *) Bp_val(_v1));
}

value camlidl_c2ml_hgraph_internal_ptr(internal_ptr * _c2, camlidl_ctx _ctx)
{
value _v1;
...
value camlidl_hgraph_hgraph_manager_alloc(value _unit)
{
  ap_manager_ptr _res;
  value _vres;
